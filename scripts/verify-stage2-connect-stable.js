...
global.setTimeout = (callback, delay, ...args) =>
  nativeSetTimeout(callback, delay === 250 || delay === 600 ? 1600 : delay, ...args);
...
Page.prototype.waitFor = function waitForWithNavigationAllowance(condition, timeout) {
  if (condition === 500) return originalWaitFor.call(this, 1600, timeout);
  return originalWaitFor.call(this, condition, timeout);
};
