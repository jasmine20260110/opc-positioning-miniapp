...
成功标志：模拟器能显示“OPC定位神器”首页，点击“开启定位”进入封面，点击“进入我的人生花园”后进入问题 1。
...
更完整的小白配置说明见 [阶段四：阿里百炼配置与验证](docs/阶段四-阿里百炼配置与验证.md)。
...
涉及真实 AI 的脚本会产生模型调用费用，并会把脚本中的虚构测试数据发送给微信云函数和阿里百炼；仅在云函数已正确配置时运行：
...
- [阶段六测试报告](docs/阶段六-测试报告.md)
- [阶段六验收场景与真机清单](docs/阶段六-验收场景与真机清单.md)
